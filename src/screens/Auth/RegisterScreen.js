            ...
            <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.content}>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.inputContainer}>
                        <Ionicons name="person-circle-outline" size={24} color="#616161" style={styles.inputIcon} />
                        <TextInput
                            style={styles.input}
                    ...
                    <View style={styles.genderContainer}>
                        {['Male', 'Female', 'Other'].map((g) => (
                            <TouchableOpacity
                                ...
                                style={[
                                    styles.genderPill,
                                    gender === g ? styles.genderPillActive : styles.genderPillInactive
                                ]}
                                onPress={() => setGender(g)}
                            >
                                <Text style={[
                                    styles.genderText,
                                    gender === g ? styles.genderTextActive : styles.genderTextInactive
                                ]}>{g}</Text>
                            </TouchableOpacity>
                        ))}
                    </View>
                ...
                <View style={styles.checkboxesSection}>
                    <TouchableOpacity style={styles.checkboxRow} onPress={() => setWhatsappUpdates(!whatsappUpdates)}>
                        <FontAwesome name="whatsapp" size={20} color="#25D366" style={styles.checkboxIconList} />
                        <Text style={styles.checkboxText}>Receive updates on Whatsapp</Text>
                        <MaterialCommunityIcons
                            name={whatsappUpdates ? "checkbox-marked" : "checkbox-blank-outline"}
                            size={24}
                    ...
                    <TouchableOpacity style={styles.checkboxRow} onPress={() => setHasReferral(!hasReferral)}>
                        <Ionicons name="gift" size={20} color="#E91E63" style={styles.checkboxIconList} />
                ...
                <View style={styles.footer}>
                    ...
                    >
                        <Text style={[
                            ...
                            isComplete ? styles.nextButtonTextActive : styles.nextButtonTextInactive
                        ]}>Next</Text>
                    </TouchableOpacity>
                </View>
