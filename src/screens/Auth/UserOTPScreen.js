        ...
        <SafeAreaView style={styles.container}>
            <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.content}>
                ...
                <View style={styles.infoSection}>
                    ...
                    <Text style={styles.sentToText}>Sent to {phone}</Text>
                </View>
                ...
                <View style={styles.resendSection}>
                    <TouchableOpacity style={styles.resendButton} disabled={timer > 0}>
                        <Ionicons name="chatbubble-outline" size={16} color={timer > 0 ? "#757575" : "black"} />
                        <Text style={[styles.resendText, { color: timer > 0 ? "#757575" : "black" }]}>
