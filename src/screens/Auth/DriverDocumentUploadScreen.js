...
import { View, Text, StyleSheet, TouchableOpacity, SafeAreaView, Dimensions, Image, Alert } from 'react-native';
    ...
    return (
        <SafeAreaView style={styles.container}>
                ...
                {image ? (
                    ...
                    <>
                        ...
                        <View style={styles.cameraControls}>
                            <Ionicons name="volume-high" size={28} color="white" style={styles.cameraIcon} />
                            <Ionicons name="sync" size={28} color="white" style={styles.cameraIcon} />
                        </View>
            ...
            <View style={styles.bottomSheet}>
                ...
                <RapidoButton
                    title="फोटो खींचें"
                    icon={<Ionicons name="camera" size={24} color="black" style={{ marginRight: 10 }} />}
                    onPress={openCamera}
                ...
                <TouchableOpacity style={styles.secondaryButton} onPress={openGallery}>
                    <Ionicons name="image-outline" size={24} color="black" style={{ marginRight: 10 }} />
