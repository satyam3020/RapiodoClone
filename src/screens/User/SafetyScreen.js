...
const SAFETY_FEATURES = [
    {
        ...
        iconColor: '#FFF',
        bgColor: '#1A237E',
        description: 'Our system continuously monitors all ongoing rides for unusual route deviations, unexpected stops, or prolonged idle time. Any anomaly triggers an automatic check-in with both the rider and captain.',
    },
    {
        id: '2',
        ...
        iconColor: '#FFF',
        bgColor: '#00897B',
        description: 'Share your real-time ride location with trusted contacts. They can track your entire journey on a map until you reach your destination safely.',
    },
    {
        id: '3',
        ...
        iconColor: '#FFF',
        bgColor: '#C62828',
        description: 'In case of an emergency, tap the SOS button during your ride. This will immediately alert our safety team and share your live location with your emergency contacts and local authorities.',
    },
    {
        id: '4',
        ...
        iconColor: '#FFF',
        bgColor: '#6A1B9A',
        description: 'Every Rapido ride comes with complimentary insurance coverage. This covers accidental injuries during the ride for both riders and captains, providing financial protection and peace of mind.',
    },
    {
        id: '5',
        ...
        iconColor: '#FFF',
        bgColor: '#E65100',
        description: 'All Rapido captains undergo thorough background verification including identity checks, driving license verification, criminal record checks, and vehicle inspection before they can start accepting rides.',
    },
];

const SAFETY_TIPS = [
    { id: '1', tip: 'Always verify the vehicle number before boarding', icon: 'car-outline' },
    { id: '2', tip: 'Share your ride details with a trusted contact', icon: 'share-social-outline' },
    { id: '3', tip: 'Wear a helmet during bike rides', icon: 'bicycle-outline' },
    { id: '4', tip: 'Use the in-app SOS button for emergencies', icon: 'alert-circle-outline' },
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.introContainer}>
                    <Text style={styles.introText}>
                        At Rapido, your safety comes first. Here are some measures and provisions to ensure your safety.
                    </Text>
                    <TouchableOpacity>
                    ...
                    {SAFETY_FEATURES.map((feature) => (
                        ...
                        >
                            <View style={styles.featureIconWrap}>
                                <Ionicons name={feature.icon} size={36} color={feature.iconColor} />
                            </View>
                ...
                <View style={styles.toggleSection}>
                    <View style={styles.toggleRow}>
                        <View style={styles.toggleInfo}>
                            ...
                            <View style={styles.toggleTextContainer}>
                                ...
                                <Text style={styles.toggleSubtitle}>Automatically share location when ride starts</Text>
                            </View>
                        </View>
                        <Switch
                            value={shareLocation}
                    ...
                    <View style={styles.toggleRow}>
                        <View style={styles.toggleInfo}>
                            <Ionicons name="notifications-outline" size={22} color="#1E2B4D" />
                            <View style={styles.toggleTextContainer}>
                                <Text style={styles.toggleTitle}>Ride safety alerts</Text>
                                <Text style={styles.toggleSubtitle}>Get notified about safety features during ride</Text>
                            </View>
                        </View>
                        <Switch
                            value={rideAlerts}
                ...
                <View style={styles.tipsContainer}>
                    {SAFETY_TIPS.map((item, index) => (
                        <View key={item.id} style={[styles.tipRow, index !== SAFETY_TIPS.length - 1 && styles.tipBorder]}>
                ...
                <View style={styles.emergencyContainer}>
                    <MaterialCommunityIcons name="phone-alert" size={30} color="#C62828" />
                    <View style={styles.emergencyContent}>
                        <Text style={styles.emergencyTitle}>Emergency Helpline</Text>
                        <Text style={styles.emergencySubtitle}>In case of emergency, call</Text>
                    </View>
                ...
                <View style={styles.modalOverlay}>
                    <View style={styles.modalContent}>
                        <View style={styles.modalHeader}>
                            <View style={[styles.modalIconContainer, { backgroundColor: selectedFeature?.bgColor || '#1E2B4D' }]}>
                                <Ionicons name={selectedFeature?.icon || 'shield'} size={28} color="#FFF" />
                            </View>
                        ...
                        <TouchableOpacity
                            style={[styles.modalButton, { backgroundColor: selectedFeature?.bgColor || '#1E2B4D' }]}
