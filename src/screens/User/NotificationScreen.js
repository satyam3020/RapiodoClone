...
const MOCK_NOTIFICATIONS = [
  {
    ...
    message:
      "Your ride from Andheri Station to Bandra Kurla Complex has been completed. Fare: ₹85.",
    time: "2 hours ago",
    type: "ride",
  ...
  },
  {
    ...
    message:
      "Your ride from Kandarpada to Dahisar Check Naka was cancelled. No charges applied.",
    time: "1 day ago",
    type: "ride",
    icon: "close-circle",
    iconColor: "#F44336",
  ...
  },
  {
    ...
    title: "Safety Update",
    message:
      "We have enhanced safety features. Now share your live ride location with trusted contacts.",
    time: "3 days ago",
    type: "info",
  ...
  },
  {
    ...
    message:
      "Payment of ₹320 for your cab ride to Chhatrapati Shivaji Airport T2 was successful.",
    time: "4 days ago",
    type: "payment",
    icon: "wallet",
    iconColor: "#00BCD4",
