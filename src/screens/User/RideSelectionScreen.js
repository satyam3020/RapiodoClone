...
export default function RideSelectionScreen({ navigation }) {
    ...
    const routeCoordinates = [
        ...
        { latitude: 19.2450, longitude: 72.8750 },
    ];
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.bottomSheet}>
                ...
                <Text style={styles.discountText}>Saving ₹12 with special discount</Text>

                <ScrollView contentContainerStyle={styles.serviceList}>
                    {/* Only Rickshaw/Auto highlighted as requested */}
                    <TouchableOpacity
                        style={[styles.serviceItem, selectedService === 'auto' && styles.selectedItem]}
                        onPress={() => setSelectedService('auto')}
                    >
                        <MaterialCommunityIcons name="rickshaw" size={40} color={Colors.secondary} />
                        <View style={styles.serviceInfo}>
                            <View style={styles.serviceHeader}>
                                <Text style={styles.serviceName}>Auto</Text>
                                <Ionicons name="person" size={12} color="#666" style={{ marginLeft: 5 }} />
                                <Text style={styles.passengerCount}>3</Text>
                            </View>
                            <Text style={styles.serviceDetails}>3 mins away • Drop 5:36 pm</Text>
                        </View>
