            ...
            <View style={styles.mapContainer}>
                ...
                {(step === 2 || step === 3) && (
                    <View style={styles.topNotification}>
                        ...
                        <Text style={styles.topNotifTitle}>{step === 2 ? 'Waiting for Captain to accept' : 'Captain is arriving in 5 mins'}</Text>
                        {/* Simulated Progress Bar */}
                        <View style={styles.progressBarContainer}>
                            <View style={[styles.progressBarFill, { width: step === 3 ? '100%' : '60%' }]} />
                        </View>
                    </View>
                )}
                ...
                {step === 1 ? (
                    ...
                    <View style={styles.sheetContent}>
                        <View style={styles.sheetHeader}>
                            <MaterialCommunityIcons name="map-marker-percent" size={28} color="#2E7D32" style={styles.headerIcon} />
                        ...
                        <TouchableOpacity
                            style={[
                                styles.pickupOption,
                                selectedPickup === 'nearby' ? styles.pickupOptionActive : styles.pickupOptionInactive
                            ]}
                        ...
                        >
                            ...
                            <View style={styles.walkSaveBadge}>
                                ...
                                <MaterialCommunityIcons name="percent-outline" size={14} color="white" style={{ marginLeft: 4 }} />
                            </View>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity
                            style={[
                                styles.pickupOption,
                                selectedPickup === 'current' ? styles.pickupOptionActive : styles.pickupOptionInactive
                            ]}
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() => setStep(2)}
                        >
                            <Text style={styles.primaryBtnText}>Continue from {selectedPickup === 'current' ? 'Current' : 'Nearby'} pickup</Text>
                        </TouchableOpacity>
                    </View>
                ) : step === 2 ? (
                    ...
                    <View style={styles.sheetContent}>
                        <View style={styles.lookingHeader}>
                            ...
                            <MaterialCommunityIcons name="rickshaw" size={40} color="#FFC107" />
                        </View>
                        ...
                        <View style={styles.actionButtons}>
                            <TouchableOpacity style={styles.primaryBtnFlat} onPress={() => navigation.goBack()}>
                    ...
                    <View style={styles.sheetContent}>
                        ...
                        <View style={styles.driverCard}>
                            ...
                            <View style={styles.driverInfo}>
                                ...
                                <Text style={styles.vehicleInfo}>Yellow Auto • MH 04 AB 1234</Text>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 20 }}>
                            <TouchableOpacity style={[styles.primaryBtnFlat, { flex: 1, marginRight: 10, marginBottom: 0 }]}>
                                <Text style={styles.primaryBtnText}>Call</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={[styles.secondaryBtn, { flex: 1, paddingVertical: 14 }]}>
                        ...
                        {/* Bottom Buttons */}
                        <View style={styles.actionButtons}>
                            <TouchableOpacity style={styles.secondaryBtn} onPress={() => navigation.navigate('Payment')}>
                                <Text style={styles.secondaryBtnText}>Complete Ride (Demo)</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                )}
