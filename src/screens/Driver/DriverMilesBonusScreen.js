    ...
    const renderDays = () => {
        ...
        return (
            <View style={styles.daysScroll}>
                {days.map((day, idx) => (
                    <View key={idx} style={[styles.dayItem, day.active && styles.activeDayItem]}>
                        <Text style={[styles.dayLabel, day.active && styles.activeDayText]}>{day.label}</Text>
                        <Text style={[styles.dayDate, day.active && styles.activeDayText]}>{day.date}</Text>
                    </View>
                ))}
            </View>
        );
            ...
            <View style={styles.topSection}>
                <View style={styles.tabsContainer}>
                    <TouchableOpacity style={[styles.tab, activeTab === 'daily' && styles.activeTab]} onPress={() => setActiveTab('daily')}>
                        <Text style={[styles.tabText, activeTab === 'daily' && styles.activeTabText]}>रोज़</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={[styles.tab, activeTab === 'weekly' && styles.activeTab]} onPress={() => setActiveTab('weekly')}>
                        <Text style={[styles.tabText, activeTab === 'weekly' && styles.activeTabText]}>साप्ताहिक</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={[styles.tab, activeTab === 'bonus' && styles.activeTab]} onPress={() => setActiveTab('bonus')}>
                        <Text style={[styles.tabText, activeTab === 'bonus' && styles.activeTabText]}>बोनस</Text>
                    </TouchableOpacity>
                </View>
                ...
                <View style={styles.emptyState}>
                    <View style={styles.emptyIconContainer}>
                        ...
                        <View style={styles.docBg}>
                            <Ionicons name="search" size={40} color="#1A437E" style={styles.searchIcon} />
                        </View>
                    </View>
                    <Text style={styles.emptyText}>माइल्स बोनस अभी तक नहीं बनाया गया है। बाद में आइए</Text>
                </View>
            </View>
        </SafeAreaView>
    );
