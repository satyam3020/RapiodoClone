...
export default function DocumentVerificationScreen({ navigation }) {
  ...
  const handleSubmit = () => {
    if (!rcUploaded || !dlUploaded) {
      Alert.alert(
        "Error",
        "Please upload both Registration Certificate and Driving License.",
      );
      return;
    }
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.subtitle}>
        Upload documents to start earning with VahaniQ
      </Text>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.cardDesc}>
          Upload a clear photo of your vehicle's RC front side.
        </Text>
        ...
        >
          <Ionicons
            name={rcUploaded ? "checkmark-circle" : "cloud-upload"}
            size={20}
            color={rcUploaded ? "#34a853" : "#1a73e8"}
          />
      ...
      <View style={styles.card}>
        ...
        >
          <Ionicons
            name={dlUploaded ? "checkmark-circle" : "cloud-upload"}
            size={20}
            color={dlUploaded ? "#34a853" : "#1a73e8"}
          />
      ...
      <TouchableOpacity
        style={[
          styles.submitBtn,
          (!rcUploaded || !dlUploaded) && styles.submitBtnDisabled,
        ]}
