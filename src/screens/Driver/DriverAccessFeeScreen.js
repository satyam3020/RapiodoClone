        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.content}>
                <View style={styles.blueBox}>
                    ...
                    <Ionicons name="car" size={60} color="#FFC107" style={{ alignSelf: 'flex-end', marginTop: 10 }} />
                </View>
                ...
                <View style={styles.pricingCard}>
                    ...
                    <View style={styles.planRow}>
                        <Text style={styles.priceText}><Text style={styles.priceBold}>₹19/-</Text> प्रति दिन</Text>
                        <Text style={styles.ridesText}><Text style={styles.ridesBold}>1-4</Text> राइड</Text>
                    </View>

                    <View style={styles.planRow}>
                        <Text style={styles.priceText}><Text style={styles.priceBold}>₹0/-</Text> प्रति दिन</Text>
                        <Text style={styles.ridesText}><Text style={styles.ridesBold}>5+</Text> राइड</Text>
                    </View>
                </View>
            </View>
        </SafeAreaView>
